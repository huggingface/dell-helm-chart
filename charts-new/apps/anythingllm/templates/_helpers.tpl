...
*/}}
{{- define "anythingllm.main.name" -}}
{{- printf "%s-main" (include "anythingllm.fullname" .) }}
{{- end }}

{{/*
Main component selector labels
*/}}
{{- define "anythingllm.main.selectorLabels" -}}
app.kubernetes.io/name: {{ include "anythingllm.name" . }}-main
app.kubernetes.io/instance: {{ .Release.Name }}
